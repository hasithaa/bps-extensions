...
public class ExtensionBundle extends AbstractExtensionBundle  {
    ...
    public void registerExtensionActivities() {
        log.info("Registering ODE Java extension operation: " + ExtensionConstants.CLASS_ACTIVITY);
        this.registerExtensionOperation(ExtensionConstants.CLASS_ACTIVITY, ClassActivitySyncExtensionOperation.class);
    }
